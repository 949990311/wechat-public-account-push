  ...
  USERS: [
    {
      ...
      id: 'o-qrO6ly2_eDKlsdF4AYb9vFj4Tk',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'mlo5GQqBU975HaPfS3qcRraVp2U-iVKuQd3175px1e4',
      // 所在省份
      province: '贵州',
      // 所在城市
      city: '遵义',
...
//         },
        ...
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
         ...
         {
          type: '节日', name: '软件设计师考试', year: '2022', date: '11-05',
         }
      ],
